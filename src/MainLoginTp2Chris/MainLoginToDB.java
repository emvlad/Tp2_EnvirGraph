...
import ViewArtistes.exeGestionArtist;

import javax.swing.JPasswordField;
import java.awt.Window.Type;

public class MainLoginToDB {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConnectionMySQL.Connecter();;
					MainLoginToDB window = new MainLoginToDB();
	...
	private void initialize() {
		...
		frmLogArtMzks.setIconImage(Toolkit.getDefaultToolkit().getImage(MainLoginToDB.class.getResource("/icons/antenna.png")));
		...
		lblconnectProg.setIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/connect.png")));
		...
		lbluserName.setIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/testimonials.png")));
		...
		lblpassWord.setIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/key1.png")));
		...
		btnValidLogin.setSelectedIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/check.png")));
		btnValidLogin.setHorizontalAlignment(SwingConstants.LEFT);
		btnValidLogin.setForeground(SystemColor.textHighlight);
		btnValidLogin.setIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/check.png")));
		...
		btnAnnulerLogin.setSelectedIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/annuler.png")));
		btnAnnulerLogin.setFont(new Font("Tahoma", Font.PLAIN, 13));
		btnAnnulerLogin.setIcon(new ImageIcon(MainLoginToDB.class.getResource("/icons/annuler.png")));
